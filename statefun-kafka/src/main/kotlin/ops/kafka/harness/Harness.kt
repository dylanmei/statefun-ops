...
object Harness {
    private val log: Logger = LoggerFactory.getLogger(Harness::class.java)
    ...
    fun generatorHarness() = StatefunHarness()
        ...
        .withSupplyingIngress(ModuleIO.KAFKA_USER_REQUEST_INGRESS_ID, KafkaUserRequestGenerator())
